...
EMOJI_DICT = {
    ...
    "💔": ["rota", "roto", "desamor", "ex", "toxic", "toxica", "toxico", "dolor de amor", "herida", "traicion amor", "mentira", "engaño", "me fallo", "me falla", "te bote", "Te Boté", "te fuiste", "ya no estas", "me dejo", "me deja", "olvidame", "no te merecia", "dolor"],
    "💋": ["beso", "besos", "besito", "labios", "boca", "muah", "besar", "besame", "dame un beso", "labios rojos", "kiss", "kissing"],
    "🫦": ["Sé que quieres", "comer", "comemos", "comerte","comersela","chocan", "choca", "freaky", "friki", "sexy", "sex", "sensual", "tentacion", "provocar", "bellaqueo", "superbellaca", "bellaca", "bellaco", "ganas", "caliente de ganas", "cosa rica", "cosas malas", "picante", "safaera", "guarachar", "guaracha", "morder", "labio", "cachonda"],
    ...
    "🥳": ["fiesta", "festejo", "party", "antro", "after", "afterparty", "farra", "parrandear", "parranda", "reventon", "reventar", "pachanga", "bulla", "vacile", "vacilando", "vacila", "joseo", "josear", "gocen"],
    "💃": ["baila", "bailar", "rumba", "bailando", "sandungueo", "sandunga", "mueve", "moviendo", "menea", "meneando", "tumbao", "afincar", "afinca", "pegao", "pegada", "saoco", "pista", "dance", "dancing", "jangueo", "janguear", "janguea", "janguiando", "salsa", "bachata"],
    ...
    "💨": ["fuma", "fumo", "fumando", "humo", "smoke", "smoking", "vape", "vapeo", "hookah", "pipa", "exhala", "gas", "nube humo", "bonga"],
    ...
    "🤬": ["jodido", "mierda", "maldito", "maldita", "carajo", "puñeta", "relajate", "diantre"],
    ...
    "🥵": ["en exceso","sudor", "sudando", "me derrito", "que calor", "sobrecalentado", "acalorado", "sofocao", "fiebre"],
    "😈": ["putilla","putona", "puta", "malo", "mala", "diablo", "diabla", "bandido", "bandida", "pecado", "portarse mal", "lado oscuro", "maldad", "villano", "villana", "mala influencia", "peligroso", "peligrosa", "tiguere", "tiguera", "malandro", "malandreo", "cabron", "cabrona", "infierno", "lucifer"],
    ...
    "💰": ["dinero", "money", "paca", "guita", "billetes", "efectivo", "millones", "millon", "riqueza", "cash", "chavos", "chavitos", "pasta", "lana", "feria", "cuartos", "billete", "pan", "bread", "cuenta millonaria", "dolares", "euros", "mucho dinero", "contando billete", "contando dinero", "plata", "bichote", "bichote'"],
    "💸": ["gasto", "gastar", "pago", "pagar", "compro", "comprar", "derrochar", "caro", "lujo", "precio alto", "designer", "gucci", "lv", "balenciaga", "versace", "dior", "prada", "fendi", "hermes", "shopping", "compras lujosas"],
    ...
    "🎧": ["audifonos", "auriculares", "dj", "mezcla", "mix", "productor", "produccion", "beats"],
    "🪩": ["discoteca", "disco", "club", "espejo bola", "en la pista",],
    ...
    "🔫": ["dispara", "plomo", "pistola", "arma", "armas", "bala", "glock", "glock 17", "draco", "ak", "ak47", "ak 47", "calibre", "gatillo", "disparo", "tiro", "shooting", "matar", "delincuente", "criminal", "criminales", "crimen", "sicario", "maleante", "pandillero", "pandilleros", "banda criminal", "glopeta", "escopeta", "pow pow"],
    ...
    "🍒": ["tetota", "tetotas", "boobies", "boobie", "pecho", "pechos", "seno", "senos", "chichis", "teta", "teta'"],
    ...
    "👅": ["mama", "lamberte", "mamarte", "lenguetazo", "darte lengua", "chupa", "chuparte"],
    # ── OGGETTI / SIMBOLI ──
    ...
    "📍": ["piercing", "arete", "stud", "punto marcado"],
    ...
    # ── ANIMALI ──
    "🦁": ["Leónidas","leon", "leona", "rugido", "fiero", "rey de la selva", "fiera", "safari"],
    ...
    "🐈": ["gata", "gato", "gatita", "gatito", "felina", "michi", "leona felina"],
